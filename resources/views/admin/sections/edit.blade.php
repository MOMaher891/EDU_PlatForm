...
@section('title', 'تعديل القسم - ' . $section->title)
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm" data-aos="fade-up">
                    ...
                    <div class="card-body">
                        <form id="editSectionForm" action="{{ route('admin.sections.update', $section) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                           id="title" name="title" value="{{ old('title', $section->title) }}" required autofocus>
                                    @error('title')
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="{{ route('admin.sections.index', $section->course) }}" class="btn btn-outline-secondary">
                    ...
                    <div class="card-body">
                        <div class="section-info">
                            ...
                            <div class="info-item mb-3">
                                ...
                                <div class="info-value">{{ $section->created_at->format('Y/m/d') }}</div>
                            </div>
                            <div class="info-item">
                                <div class="info-label">آخر تحديث:</div>
                                <div class="info-value">{{ $section->updated_at->format('Y/m/d') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="card-body">
                        <div class="quick-actions">
                            <a href="{{ route('admin.lessons.index', $section) }}" class="btn btn-outline-primary btn-sm w-100 mb-2">
                                <i class="fas fa-play me-1"></i>
                                إدارة الدروس
                            </a>
                            <a href="{{ route('admin.sections.index', $section->course) }}" class="btn btn-outline-secondary btn-sm w-100">
